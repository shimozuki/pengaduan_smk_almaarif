...
class DashboardSettingController extends Controller
{
    ...
    public function update(Request $request, Setting $setting)
    {
        $credentials = $request->validate([
            ...
            "WEB_LOGO_WHITE" => ["nullable", "file", "image", "mimes:png,jpg", "max:5024"],
            "OLD_WEB_LOGO_WHITE" => ["required", "string"],

            "WEB_LOGO" => ["nullable", "file", "image", "mimes:png,jpg", "max:5024"],
            "OLD_WEB_LOGO" => ["required", "string"],

            "WEB_FAVICON" => ["nullable", "file", "image", "mimes:png,jpg", "max:5024"],
            "OLD_WEB_FAVICON" => ["required", "string"],

            "FOOTER_IMAGE" => ["nullable", "file", "image", "mimes:png,jpg", "max:5024"],
            "OLD_FOOTER_IMAGE" => ["required", "string"],

            "FOOTER_IMAGE_DASHBOARD" => ["nullable", "file", "image", "mimes:png,jpg", "max:5024"],
